              ...
              {tagPerformance.length > 0 ? (
                <div className="flex gap-3">
                  {tagPerformance.map(tag => (
                    <div key={tag.tagId} className="relative flex-1 bg-slate-800/50 rounded-xl p-3 border border-slate-700/30">
                      {/* Emoji + Tag Name */}
                      ...
                      {/* P&L Amount - Centered */}
                      <div className={`text-center text-lg font-black mb-3 ${tag.totalPL >= 0 ? 'text-emerald-400' : 'text-red-400'}`}>
                      ...
                      <div className="mb-1">
                        ...
                        <div className="text-[10px] text-slate-400 mt-1 text-center">{tag.winRate}% Win Rate</div>
                      </div>
                      ...
                      <div className="absolute bottom-2 right-2 w-6 h-6 bg-gradient-to-br from-blue-600 to-purple-600 rounded-full flex items-center justify-center shadow-lg border border-slate-700">
                        <span className="text-[10px] font-black text-white">{tag.trades}</span>
                      </div>
                    </div>
                  ))}
                </div>
