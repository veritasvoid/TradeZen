      ...
      <div className="max-w-[1800px] mx-auto p-6 space-y-4">
        ...
        <div className="flex items-center justify-center gap-4 mb-2">
          <button
            ...
            className="px-4 py-2 bg-slate-800 hover:bg-slate-700 rounded-lg transition-all text-sm font-semibold"
          >
            ← {selectedYear - 1}
          </button>
          ...
          <button
            ...
            className="px-4 py-2 bg-slate-800 hover:bg-slate-700 disabled:opacity-30 disabled:cursor-not-allowed rounded-lg transition-all text-sm font-semibold"
          >
            {selectedYear + 1} →
          </button>
        </div>
